...
export const TEMPLATE_MODERN_REALTY: TemplateDefinition = {
    ...
    thumbnailUrl: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&q=80&w=400',
...
export const TEMPLATE_LUXURY_ESTATE: TemplateDefinition = {
    ...
    thumbnailUrl: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=400',
    lockedSections: ['hero', 'featured_listings', 'contact_cta'],
    allowedSections: [
...
export const TEMPLATE_MINIMAL_REALTY: TemplateDefinition = {
    ...
    thumbnailUrl: 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?auto=format&fit=crop&q=80&w=400',
    lockedSections: ['hero', 'featured_listings'],
