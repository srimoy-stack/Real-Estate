...
const getInitialWebsite = (): OrgWebsite => {
    ...
    return {
        ...
        organizationName: 'SquareFT Realty Group',
        status: 'ACTIVE',
    ...
    return [
        {
            ...
            seo: {
                metaTitle: 'SquareFT | Your Premier Real Estate Partner',
                metaDescription: 'Discover luxury homes and expert real estate services with SquareFT.',
                ogTitle: 'SquareFT | Luxury Real Estate',
        ...
        },
        {
            ...
            seo: {
                metaTitle: 'About SquareFT | Our Mission & Team',
                metaDescription: 'Learn about the history and dedicated team behind SquareFT.',
            },
            pageType: 'static',
            isPublished: true,
            isPublic: true,
        ...
        },
        {
            ...
            seo: {
                metaTitle: 'Explore Local Communities | SquareFT',
...
let mockBranding: OrgWebsiteBranding = {
    ...
    siteTitle: 'SquareFT Realty Group',
    createdAt: '2024-01-15T10:00:00Z',
    updatedAt: '2025-11-20T14:30:00Z',
};
...
let mockAgentProfiles: WebsiteAgentProfile[] = [
    ...
    },
    {
        ...
        phone: '(416) 555-0203',
        email: 'michael.chen@squareft.com',
        displayOrder: 3,
        isVisible: false,
        createdAt: '2024-03-22T12:00:00Z',
        updatedAt: '2025-09-15T08:30:00Z',
