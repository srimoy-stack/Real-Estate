...
export function TemplatePreviewPopup({ templateId, onClose }: TemplatePreviewPopupProps) {
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-slate-950/60 backdrop-blur-md flex flex-col overflow-hidden animate-in fade-in duration-300">
            ...
            <main className="flex-1 relative flex justify-center bg-slate-200/50 overflow-hidden pt-8">
                <div
                    className="h-full bg-white shadow-[0_0_100px_rgba(0,0,0,0.15)] rounded-t-2xl transition-all duration-500 border-x border-t border-slate-300 overflow-hidden animate-in slide-in-from-bottom duration-500"
