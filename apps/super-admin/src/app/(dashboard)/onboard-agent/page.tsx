                ...
                <div className="w-full md:w-72 bg-gradient-to-b from-violet-900 to-slate-900 p-10 text-white flex flex-col shrink-0">
                    ...
                    <div className="flex-1 space-y-6">
                        {[
                            ...
                            { s: 3, label: 'Listing Filters' },
                            { s: 4, label: 'SEO & Submit' },
                        ].map(item => (
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-2 gap-5 bg-slate-50/70 p-7 rounded-[28px]">
                                ...
                                <div className="space-y-1.5"><label className={labelCls}>Brokerage (optional)</label><input type="text" value={form.brokerage} onChange={e => update({ brokerage: e.target.value })} className={inputCls} placeholder="Organization ID or name" /></div>
