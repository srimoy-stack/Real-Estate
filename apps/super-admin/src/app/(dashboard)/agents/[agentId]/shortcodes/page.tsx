...
export default function AgentShortcodesPage() {
    ...
    useEffect(() => {
        (async () => {
            ...
            // Mock shortcodes for this agent
            setShortcodes([
                {
                    id: 'sc_a1',
                    organizationId: data?.organizationId || null,
                    websiteId: `ws_agent_${agentId}`,
                    createdByRole: 'super_admin',
                    shortcodeName: 'myListings',
        ...
        <div className="p-8 space-y-10 animate-in fade-in duration-500">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Manage listing queries for Agent: {agent?.name || 'Agent'}</p>
                </div>
                <button
