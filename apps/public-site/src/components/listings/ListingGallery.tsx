            ...
            >
                ...
                {virtualTourUrl && (
                    <a
                        ...
                        className="absolute top-6 left-6 bg-[#4F46E5]/90 backdrop-blur-xl text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl z-20 border border-[#4F46E5]/30 hover:bg-indigo-500 transition-colors flex items-center gap-2"
                    >
