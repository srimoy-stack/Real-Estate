            ...
            <section className="py-24 bg-slate-950">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {listings.slice(0, 6).map(l => <PropertyCard key={l.id} listing={l} variant="luxury" />)}
                    </div>
                </div>
            </section>
        );
            ...
            <section className="py-20 bg-slate-50">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {listings.slice(0, 6).map(l => <PropertyCard key={l.id} listing={l} variant="corporate" />)}
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {listings.slice(0, 6).map(l => <PropertyCard key={l.id} listing={l} variant="minimal" />)}
                    </div>
                </div>
            </section>
        );
    ...
    return (
        <section className="py-24 bg-slate-50">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {listings.slice(0, 6).map(l => <PropertyCard key={l.id} listing={l} variant="default" />)}
                </div>
                <div className="text-center mt-12">
